    ...
    return (
        ...
        <div className='background'>
            ...
            <div className="menu-button-container">
                <div className="menu-button deg0" onClick = {() => {history.push('/books')}}>
                    <div>
                        <MenuButton />
                    </div>
                    <div>
                ...
                <div className="menu-button deg120" onClick = {() => {history.push('/movies')}}>
                    <div>
                        <MenuButton/>
                    </div>
                    <div>
                ...
                <div className="menu-button deg240" onClick = {() => {history.push('/games')}}>
                    <div>
                        <MenuButton/>
                    </div>
                    <div>
            ...
            <div className="menu-button-container inner">
                <div className="menu-button deg0" onClick = {() => {history.push('/about')}}>
                    <div>
                        <MenuButton/>
                    </div>
                    <div>
                ...
                <div className="menu-button deg120" onClick = {() => {history.push('/contact')}}>
                    <div>
                        <MenuButton/>
                    </div>
                    <div>
                ...
                <div className="menu-button deg240" onClick = {() => {history.push('/thanks')}}>
                    <div>
                        <MenuButton/>
                    </div>
                    <div>
