          ...
          <div className="info-container">
            <div className="info">
              ...
              <div className="adjacent-items">
                {previtem !== null && (
                  <div
                    className="box prev hover-anim"
                    onClick={(event) => handleClick(previtem._id)}
                  >
                    <img src={previtem.cover} alt="Previous" />
                  </div>
                )}
                <div
                  className="box back hover-anim"
                ...
                {nextitem && (
                  <div
                    className="box next hover-anim"
                    onClick={(event) => handleClick(nextitem._id)}
                  >
