...
const AboutProject = () => {
    return (
        <div className="container about-project">
            ...
            <p>Things may seem like a little bit "over-designed". This is because of a silly idea of mine that the best way to show my proficiency also includes making things seem pretty. Anyway, thanks for visiting this site. If you want to work with me, or else give some professional advice, my contact info is <a href="/contact">here</a>.</p>  
        </div>            
    )
}
