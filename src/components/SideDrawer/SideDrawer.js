    ...
    return (
        <div>
            <nav className={drawerClasses}>
                <ul>
                    <li style={{position:"absolute", top:"2rem", left:"0.1rem", cursor:"pointer", marginBottom:"3rem"}} onClick={()=>history.push("/")}>
                        <h2>REVIEWS APP</h2>
                    </li>
                    ...
                    <li style={{marginBottom:"2rem"}}><NavLink to="/movies">Movies</NavLink></li>
